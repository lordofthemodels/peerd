    ...
    try {
      ...
      const actorSurface = latchedActorSurface ?? record.actorSurface
        ?? (kind === 'web' && record.backing !== 'api'
          ? resolveWebActorSurface({
            requested: deps.settingsStore.get().webActorActionSurface,
      ...
      if (!persisted) return withLandingStop({
